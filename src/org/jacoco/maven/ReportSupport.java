...
final class ReportSupport {
	...
	/**
	 * Calculates coverage for the given project and class files, and emits it to the report
	 * group including source references
	 *
	 * @author czt
	 * @since 2021-06-10
